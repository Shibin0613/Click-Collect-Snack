...
<body>
    ...
    <div class="flex">
        ...
        if (isset($_SESSION['wagen'])):
            ...
            <button name="bestel" class="bestel">Bestel</button><input name="ophaaltijd" type='time' class="time" value="<?php $time=date_default_timezone_get(); $time=date("H:i", strtotime("+30 minutes")); echo $time;?>" min="12:00" min='<?php echo $time; ?>' max='21:00' required>
